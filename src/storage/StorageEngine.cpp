...
// {
//     status = _blocks->Put(leveldb::WriteOptions(), block.hash(), block.json().dump());
// }
...
// void keyser::StorageEngine::saveWallets(const Wallet& wallet)
// {
//     status = _wallets->Put(leveldb::WriteOptions(), "wallets", wallet.json().dump());
// }

// void keyser::StorageEngine::loadWallets(Wallet& wallet)
// {
//     std::string jsonStr;
